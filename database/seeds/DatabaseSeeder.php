...
{   
  private $arrayPeliculas = array(
		...
		array(
			...
			'year' => '1987', 
			'director' => 'Stanley Kubrick', 
			'poster' => 'http://www.hispashare.com/images/cover.php?id=474', 
			'rented' => true, 
		...
		array(
			...
			'poster' => 'https://d2a0bnlkc0czvp.cloudfront.net/posters/thumb/p4190_p_v5_aa.jpg?1473794262', 
			'rented' => true, 
    ...
    private function seedUsers(){
         ...
         $user = new User;
         $user->name = "Jesus";
         $user->email = "prueba1@ejemplo.com";
         $user->password = bcrypt( 12345 );
         $user->save();
         $user2 = new User;
         $user2->name = "Jesus2";
         $user2->email = "prueba2@ejemplo.com";
         $user2->password = bcrypt( 67891 );
         $user2->save();
    }
